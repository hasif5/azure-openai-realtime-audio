...
// Helper function to get the backend endpoint from environment variables
const getBackendEndpoint = () => {
  let endpoint = "ws://localhost:8080/realtime"; // Default value 
  if (typeof process !== "undefined" && process.env.NEXT_PUBLIC_BACKEND_ENDPOINT) {
...
const ChatInterface = () => {
  const initialEndpoint = getBackendEndpoint();
